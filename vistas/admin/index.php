...
$info = $con->prepare("SELECT * FROM usuario WHERE documento= '" . $_SESSION['documento'] . "' ");
$info->execute();
$fila = $info->fetch();
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">SIS - Seguridad </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="./entradas/entrada.php">Entrada</a>
                        <a class="collapse-item" href="./tablas/entrada.php">Informes de Entrada</a>
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="../../images/<?= $fila['foto'] ?>">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <form action="actualizar/recupe.php" method="post">
                                    <input type="hidden">
                                    <button type="submit" name="recufas" class="dropdown-item"><i
                                            class="bi bi-key fa-sm fa-fw mr-2 text-gray-400"></i> Cambio
                                        Contraseña</button>
                                </form>
